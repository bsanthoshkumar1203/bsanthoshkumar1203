...
<p align="center">
  <img src="profile-round.png" width="180" style="border-radius:50%;" alt="Santhosh Kumar" />
</p>
...
**Software Developer | Java Developer | Backend Developer | Full Stack Developer**

I want to work on real-world applications, improve my technical skills, and contribute to a professional development team.
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=git,github,vscode,eclipse,maven,postman&theme=dark" />
</p>
...
**HireFlow** is a full-stack Applicant Tracking System designed to help organizations manage the recruitment process.
...
`React` `JavaScript` `Node.js` `Express.js` `MongoDB` `REST API`
...
`Python` `Deep Learning` `GAN` `Computer Vision`
...
Currently practicing programming problems to improve my logical thinking and algorithmic skills.
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Java-2E9EF7?style=flat-square" />
  <img src="https://img.shields.io/badge/Backend_Development-2E9EF7?style=flat-square" />
  <img src="https://img.shields.io/badge/SQL-2E9EF7?style=flat-square" />
...
> I enjoy solving coding problems and turning ideas into working applications.
> Every bug is another opportunity to learn something new! 🚀
